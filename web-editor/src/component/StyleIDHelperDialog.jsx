		...
		<div>
			...
			>
				...
				<DialogContent>
					...
					<br />
					<br />
					<b>A note on the map watermarks</b>: it's tempting to crop them out with OBS, however most mapping providers require displaying attribution, even when used in non-interactive video. Verify you are meeting the relevant attribution requirements for your mapping provider. RealtimeIRL does not provide legal support if you are contacted regarding an attribution violation.
					<br />
					<br />
					Please review the <br />
          <a
            href="https://docs.mapbox.com/help/getting-started/attribution/#static--print"
